;$Author: johnson $
;$Date: 2013/09/06 17:40:34 $
;$Header: /home/cdaweb/dev/control/RCS/plot_radar.pro,v 1.17 2013/09/06 17:40:34 johnson Exp johnson $
;$Locker: johnson $
;$Revision: 1.17 $
;
...
; Establish error handler
  ...
  -133 or -142 or -146: begin
       print, 'STATUS= No data available for this time range.  Re-select variable(s) or time range. '  
      end
  -176: begin
       print, 'STATUS=Array has 0 elements, cannot plot.' 
      end
  else: begin
