;$author: baldwin $
;$Date: 2018/06/13 17:28:51 $
;$Header: /home/cdaweb/dev/control/RCS/map_keywords.pro,v 1.34 2018/06/13 17:28:51 johnson Exp rcjohns1 $
;$Locker: rcjohns1 $
;$Revision: 1.34 $
;+------------------------------------------------------------------------
...
; RCJ 24Feb2023  Changed these statements bc someone could set the field
; to 0 in the interface, which translates into 'field not set' in html.
; The consequence is that one of these keywords=value could be simply
; missing from our idl*.key file but the user meant it to be =0
