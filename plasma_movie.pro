;$Author: kovalick $ 
;$Date: 2018/12/19 20:18:17 $
;$Header: /home/cdaweb/dev/control/RCS/plasma_movie.pro,v 1.19 2018/12/19 20:18:17 kovalick Exp tkovalic $
;$Locker: tkovalic $
;$Revision: 1.19 $
;+------------------------------------------------------------------------
; NAME: PLASMA_MOVIE
...
;                  2/13/2023 woring on viritis and batlow options
;
; OUTPUTS:
...
FUNCTION plasma_movie, astruct, zname, $
                      ...
                      CDAWEB=CDAWEB,DEBUG=DEBUG,COLORBAR=COLORBAR,COLORTAB=COLORTAB
...
;for parsing the output for the web site)
  ...
  for j = 0, n_images-1 do begin
    ...
    s=plot_plasmagram(astruct, zname , FRAME=j+1, GIF=GIF1, $
 		       /COLORBAR, /MOVIE, COLORTAB=COLORTAB) 
