;$Author: johnson $
;$Date: 2012/05/03 02:17:54 $
;$Header: /home/cdaweb/dev/control/RCS/create_vis.pro,v 1.16
;2012/05/03 02:17:54 johnson Exp kovalick $
;$Locker: kovalick $
;$Revision: 1.16 $
;Function: create_vis
...
for k = 0, num_recs-1 do begin 
  ...
  ; TJK 8/2/2017 if record.epoch is not positive then can't call
  ; compute_crds or any of the other routines below so return the
  ; original structure.

  if (record.epoch lt 0) then return, astruct
