...
base  = widget_base(/Column,Title=('Variable Attributes: '+vname),$
                    /frame,uvalue=a, XOFFSET=xyoff[0]/2, YOFFSET=xyoff[1]/2)
base1 = widget_base(base,/Column, XOFFSET=xyoff[0]/2, YOFFSET=xyoff[1]/2)
base2 = widget_base(base,/Column, XOFFSET=xyoff[0]/2, YOFFSET=xyoff[1]/2)
base3 = widget_base(base,/Row,/frame, XOFFSET=xyoff[0]/2, YOFFSET=xyoff[1]/2)
