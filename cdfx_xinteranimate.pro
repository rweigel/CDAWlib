...
base1 = widget_base(/Column,Title='Image Animation', XOFFSET=xyoff[0]/2, YOFFSET=xyoff[1]/2)
...
base2 = widget_base(base1,Row=2, XOFFSET=xyoff[0]/2, YOFFSET=xyoff[1]/2)
...
base3 = widget_base(base1,/Column,/frame, XOFFSET=xyoff[0]/2, YOFFSET=xyoff[1]/2)
...
but3d = CW_BGROUP(base3,['On','Off'],label_left='Edge Enhancement    :',$
                  /row,/exclusive,set_value=1)
base4 = widget_base(base1,/Row,/frame, XOFFSET=xyoff[0]/2, YOFFSET=xyoff[1]/2)
