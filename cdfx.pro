...
; Create the widget
base1 = widget_base(/Column,Title='Restore Data Objects',/frame, XOFFSET=xyoff[0]/2, YOFFSET=xyoff[1]/2)
...
base2 = widget_base(base1,/Row, XOFFSET=xyoff[0]/2, YOFFSET=xyoff[1]/2)
...
;TJK 8/16/2017 added this next line because lsource needs to be a plain string
;in order to be used below as a widget label.
lsource = lsource[0]
...
; Create the widget
base1 = widget_base(/Column,Title=('Data Object '+letter),/frame, XOFFSET=xyoff[0]/2, YOFFSET=xyoff[1]/2)
base2 = widget_base(base1,/Column, XOFFSET=xyoff[0]/2, YOFFSET=xyoff[1]/2)
base3 = widget_base(base1,/Row, XOFFSET=xyoff[0]/2, YOFFSET=xyoff[1]/2)
...
base01 = widget_base(/Column,Title='CDFx',/frame, XOFFSET=xyoff[0]/2, YOFFSET=xyoff[1]/2)
...
base2 = widget_base(base01,/Column,/BASE_ALIGN_CENTER, XOFFSET=xyoff[0]/2, YOFFSET=xyoff[1]/2)
junk1 =  {CW_PDMENU_S, flags:0, name:''}
