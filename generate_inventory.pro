;$Author: rcjohns1 $
;$Date: 2020/03/10 03:56:09 $
;$Header: /home/cdaweb/dev/control/RCS/generate_inventory.pro,v 1.29 2020/03/10 03:56:09 rcjohns1 Exp rcjohns1 $
;$Locker: rcjohns1 $
;$Revision: 1.29 $
;---------------------------------------------------------------------------
...
s=draw_inventory(a,TITLE='Active Mission Data 1960-2034', $
PNG='/home/cdaweb/metadata/istp_public_cdfmetafile.png',$
/long_line, /wide_margin, $
START_TIME='1960/01/01 00:00:00', STOP_TIME='2034/01/01 23:59:59', /BIGPLOT)
a=aa
...
a=aa
s=draw_inventory(a,TITLE='ISTP PUBLIC DATA 2030-2034', $
PNG='/var/www/cdaweb/htdocs/istp_public/avail_2030-2034.png',$
/long_line, /wide_margin, $
START_TIME='2030/01/01 00:00:00', STOP_TIME='2034/12/31 23:59:59', /debug, /FIVEYEAR)
;
delvar, a,aa
