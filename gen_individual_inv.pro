...
ds_list = ['MSL_']
datasets = get_datasets(ds_list, '/home/cdaweb/metadata/sp_phys_cdfmetafile.txt')
if (datasets[0] ne '') then print,'Generating MSL'
if (datasets[0] ne '') then a = ingest_database('/home/cdaweb/metadata/sp_phys_cdfmetafile.txt',DATASETS=datasets)
; Draw inventory graph...
if (datasets[0] ne '') then s=draw_inventory(a,TITLE='Mars Science Laboratory (MSL) CDAWeb Inventory',PNG='/var/www/cdaweb/htdocs/sc_inventory_plots/MSL_Public_Inventory.png',/debug)
if (datasets[0] ne '') then delvar, a
...
a = a2
if (datasets[0] ne '') then s=draw_inventory(a,TITLE='PSP 2023 CDAWeb Inventory',PNG='/var/www/cdaweb/htdocs/sc_inventory_plots/PSP-2023_Inventory.png', START_TIME='2023/01/01 00:00:00', STOP_TIME='2024/01/01 00:00:00', /debug)
if (datasets[0] ne '') then delvar, a
...
ds_list = ['REACH']
datasets = get_datasets(ds_list, '/home/cdaweb/metadata/sp_phys_cdfmetafile.txt')
if (datasets[0] ne '') then print,'Generating REACH'
if (datasets[0] ne '') then a = ingest_database('/home/cdaweb/metadata/sp_phys_cdfmetafile.txt',DATASETS=datasets)
; Draw inventory graph...
if (datasets[0] ne '') then s=draw_inventory(a,/wide_margin,TITLE='REACH CDAWeb Inventory',PNG='/var/www/cdaweb/htdocs/sc_inventory_plots/REACH_Inventory.png',/debug)
if (datasets[0] ne '') then delvar, a
...
; Read the metadata file...
;ds_list = ['RENU2_','ENDURANCE_'] ;  these 2 might not work together, their start/stop times are too
;      far apart and there's data for a very small amount of time.  
...
a = a2
if (datasets[0] ne '') then s=draw_inventory(a,TITLE='Solar-Orbiter 2023 CDAWeb Inventory',PNG='/var/www/cdaweb/htdocs/sc_inventory_plots/SOLO-2023_Inventory.png', START_TIME='2023/01/01 00:00:00', STOP_TIME='2024/01/01 00:00:00', /debug)
if (datasets[0] ne '') then delvar, a
